        ...
        <li class="active treeview">
         ...
         <ul class="treeview-menu">
		  <li><a href="allcontent"><i class="fa fa-circle-o"></i> All Content</a></li>
            <li class="active"><a href="news"><i class="fa fa-circle-o"></i> News</a></li>
		...
		<input type="text" class="form-control" readonly  placeholder="Thumbnail" id="imagename" name="imagename">
		 ...
		 <label class="input-group-btn">
            <span class="btn btn-primary">
             Unggah&hellip; <input type="file" style="display: none;" name="uploadimage" id="uploadimage" onchange="setfilename(this.value);">
            </span>
         </label>
		</div>
		</div>
