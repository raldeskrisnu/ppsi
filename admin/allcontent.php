    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
		 ...
		 <li class="active"><a href="allcontent"><i class="fa fa-circle-o"></i> All Content</a></li>
				...
				<div class="box">
                     ...
                     <div class="box-body table-responsive no-padding">
                        <?php
                           ...
                           $sql = mysqli_query("SELECT COUNT(id_content) as num FROM main_content") or die (mysqli_error());
                           $total_pages = mysqli_fetch_array($sql);
                            $yourcount = $total_pages['num'];
                           $no =1;
                           $limit = 10;
                           $adjacents = 50;
                           $targetpage = "allcontent.php";
					 ...
					 <table class="table table-hover">
						...
						$sql = "SELECT main_content.id_content, main_content.id_category, main_content.title, main_content.date, main_content.author, main_content.show_content, category.name_category FROM main_content INNER JOIN category ON main_content.id_category=category.id_category order by main_content.id_content DESC LIMIT $start, $limit";
                        ...
                        <tbody>
						   ...
						   <td><?php echo $row['date'] ?></td>
							...
							<?php $id = $row['id_content']; ?>
                           <td width="200px">
                              <center><!--<button class="btn btn-primary" data-toggle="modal" data-target="#<?php echo $row['id_content'] ?>">Ubah</button> -->
                                 <button class="btn btn-primary" data-toggle="modal" data-target="#false">Delete</button>
								<?php
									if($row['show_content'] == '0')
									{
										echo ' <button class="btn btn-primary" data-toggle="modal" data-target="#'. $row["id_content"] .'">show</button>';
									} else if($row['show_content'] == '1')
									{
										echo ' <button class="btn btn-primary" data-toggle="modal" data-target="#'. $row["id_content"] .'">unshow</button>';
									}
								 ?>
                           ...
                           <div class="modal fade" id="false" tabindex="-1" role="dialog" aria-labelledby="yourmodallabel" aria-hidden="true">
                              <form action="deletecontent" method="post" id="clickform" class="form-horizontal">
                                    ...
                                    <div class="modal-content">
                                       ...
                                       <div class="modal-body">
                                          ...
                                          <center>
                                             ...
                                             <button name="idform" type="submit" class="btn btn-primary" value="<?php echo $row['id_content'] ?>">Delete</button>
