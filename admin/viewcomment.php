				...
				<div class="box">
                      <div class="box-body table-responsive no-padding">
					    ...
					    <?php
                           ...
                           $sql = mysql_query("SELECT COUNT(id_comment) as num FROM comment_user") or die (mysql_error());
					 ...
					 <table class="table table-hover">
						...
						$sql = "SELECT comment_user.id_comment, comment_user.id_user, comment_user.comment, comment_user.date, user.name FROM comment_user INNER JOIN user ON comment_user.id_user=user.id_user order by comment_user.id_comment DESC LIMIT $start, $limit";
                                 ...
                                 <div class="modal-dialog">
                                    <div class="modal-content">
                                       ...
                                       <div class="modal-body">
                                          <!-- Start -->
                                          <center>
                                             <h4> Are you sure delete this comment? </h4>
                                             <button name="idform" type="submit" class="btn btn-primary" value="<?php echo $row['id_comment'] ?>">Delete</button>
